module.exports = [{
    ...
    "short_des": "The redwing (Turdus iliacus) is a bird in the thrush family, Turdidae, native to Europe and Asia, slightly smaller than the related song thrush. It is 20–24 cm long with a wingspan of 33–34.5 cm and a weight of 50–75 g."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Feral pigeons (Columba livia domestica), also called city doves, city pigeons, or street pigeons, are pigeons that are derived from the domestic pigeons that have returned to the wild. The domestic pigeon was originally bred from the wild rock dove."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Tufted duck (Aythya fuligula) is a small diving duck with a population of close to one million birds. The scientific name is derived from Ancient Greek aithuia an unidentified seabird mentioned by authors including Hesychius and Aristotle."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common merganser (North American) or goosander (Eurasian) (Mergus merganser) is a large duck of rivers and lakes in forested areas of Europe, northern and central Asia, and North America."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Canada goose (Branta canadensis) is a large wild goose species with a black head and neck, white patches on the face, and a brown body. Native to arctic and temperate regions of North America, its migration occasionally reaches northern Europe."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The mallard (/ˈmælɑːrd/ or /ˈmælərd/) or wild duck (Anas platyrhynchos) is a dabbling duck which breeds throughout the temperate and subtropical Americas, Europe, Asia, and North Africa, and has been introduced to New Zealand, Australia, Peru, & Brazil"
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common wood pigeon (Columba palumbus) is a large species in the dove and pigeon family. It belongs to the Columba genus and, like all pigeons and doves, belongs to the family Columbidae. It is locally known in southeast England as the \"culver\"."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The black-headed gull (Chroicocephalus ridibundus) is a small gull that breeds in much of Europe and Asia, and also in coastal eastern Canada. Most of the population is migratory and winters further south, but some birds reside in the milder west."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Magpies are birds of the Corvidae (crow) family, including the black and white Eurasian magpie, which is considered one of the most intelligent animals in the world, and the only non-mammal species able to recognize itself in a mirror test."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The rose-ringed parakeet (Psittacula krameri), also known as the ring-necked parakeet, is a gregarious tropical Afro-Asian parakeet species that has an extremely large range.\nThe rose-ringed parakeet is sexually dimorphic."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Moorhens — sometimes called marsh hens — are medium-sized water birds that are members of the rail family, (Rallidae). Most species are placed in the genus Gallinula, Latin for \"little hen\". They are close relatives of coots."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common blackbird (Turdus merula) is a species of true thrush. It is also called Eurasian blackbird (especially in North America, to distinguish it from the unrelated New World blackbirds)."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The European goldfinch or goldfinch (Carduelis carduelis), is a small passerine bird in the finch family that is native to Europe, North Africa and western Asia. It has been introduced to other areas including Australia, New Zealand and Uruguay."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Eurasian blue tit (Cyanistes caeruleus) is a small passerine bird in the tit family Paridae. The bird is easily recognisable by its blue and yellow plumage and its size."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Coots are small water birds that are members of the Rallidae (rail) family. They constitute the genus Fulica, the name being the Latin for \"coot\". Coots have predominantly black plumage, and—unlike many rails—they are usually easy to see."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The nuthatches constitute a genus, Sitta, of small passerine birds belonging to the family Sittidae. Characterised by large heads, short tails, and powerful bills and feet, nuthatches advertise their territory using loud, simple songs."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The great tit (Parus major) is a passerine bird in the tit family Paridae. It is a widespread and common species throughout Europe, the Middle East, Central and Northern Asia, and parts of North Africa where it is generally resident."
}, {
    "taxon_group": "Bird",
    ...
    "description": "The goldcrest (Regulus regulus) is a very small passerine bird in the kinglet family. Its colourful golden crest feathers gives rise to its English and scientific names, and possibly to it being called the \"king of the birds\" in European folklore. Birds from the north and east of its breeding range migrate to winter further south.\nThis kinglet has greenish upper-parts, whitish under-parts, and has two white wingbars. It has a plain face contrasting black irises and a bright head crest, orange and yellow in the male and yellow in the female, which is displayed during breeding. The song is a repetition of high thin notes, slightly higher-pitched than those of its relative.\nThe goldcrest breeds in coniferous woodland and gardens, building its compact, three-layered nest on a tree branch. Ten to twelve eggs are incubated by the female alone, and the chicks are fed by both parents; second broods are common. It may be killed by birds of prey or carry parasites, but its large range and population mean that it is not considered to present any significant conservation concerns.",
    "short_des": "The goldcrest (Regulus regulus) is a very small passerine bird in the kinglet family. Its colourful golden crest feathers gives rise to its English and scientific names, and possibly to it being called the \"king of the birds\" in European folklore."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The European robin (Erithacus rubecula), known simply as the robin or robin redbreast in the British Isles, is a small insectivorous passerine bird."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The shovelers (American English), or shovellers (British English), are four species of dabbling ducks with long, broad spatula-shaped beaks."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The mute swan (Cygnus olor) is a species of swan and a member of the waterfowl family Anatidae. It is native to much of Europe and Asia, and (as a rare winter visitor) the far north of Africa."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The treecreepers are a family, Certhiidae, of small passerine birds, widespread in wooded regions of the Northern Hemisphere and sub-Saharan Africa. The family contains ten species in two genera, Certhia and Salpornis. Their plumage is dull-coloured,"
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The wrens are mostly small, brownish passerine birds in the mainly New World family Troglodytidae. About 80 species of true wrens in roughly 20 genera are described. Most wrens are small and rather inconspicuous, except for their loud and often complex songs."
}, {
    "taxon_group": "Bird",
    ...
    "description": "The carrion crow (Corvus corone) is a passerine bird of the family Corvidae and the genus Corvus which is native to western Europe and eastern Asia. The plumage of carrion crow is black with a green or purple sheen, much greener than the gloss of the rook. The bill, legs and feet are also black. It can be distinguished from the common raven by its size (48–52 cm or 18 to 21 inches in length as compared to an average of 63 centimetres (25 inches) for ravens) and from the hooded crow by its black plumage, but there is frequent confusion between it and the rook. It has a wingspan of 84–100 cm or 33 to 39 inches. The beak of the crow is stouter and in consequence looks shorter, and whereas in the adult rook the nostrils are bare, those of the crow are covered at all ages with bristle-like feathers.",
    "short_des": "The carrion crow (Corvus corone) is a passerine bird of the family Corvidae and the genus Corvus which is native to western Europe and eastern Asia. The plumage of carrion crow is black with a green or purple sheen, much greener than the gloss of the rook."
}, {
    "taxon_group": "Bird",
    ...
    "description": "The stock dove (Columba oenas) is a species of bird in the family Columbidae, the doves and pigeons.\n\n The genus Columba is the largest within the pigeon family, and has the widest distribution. Its members are typically pale grey or brown, often with white head or neck markings or iridescent green or purple patches on the neck and breast. The neck feathers may be stiffened and aligned to form grooves, but these are absent in this species. The stock dove is sociable as well as gregarious, often consorting with wood pigeons, though doubtless it is the presence of food which brings them together.",
    "short_des": "The stock dove (Columba oenas) is a species of bird in the family Columbidae, the doves and pigeons.\n\n The genus Columba is the largest within the pigeon family, and has the widest distribution. Its members are typically pale grey or brown, often with a white head."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The song thrush (Turdus philomelos) is a thrush that breeds across much of Eurasia. It has brown upperparts and black-spotted cream or buff underparts and has three recognised subspecies. Its distinctive song, which has repeated musical phrases, has requently been referred to in poetry "
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The waxwings are passerine birds classified in the genus Bombycilla. They are brown and pale grey with silky plumage, a black and white eyestripe, a crest, a square-cut tail and pointed wings. Some of the wing feathers have red tips."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Eurasian siskin (Spinus spinus) is a small passerine bird in the finch family Fringillidae. It is also called the European siskin, common siskin or just siskin. Other (archaic) names include black-headed goldfinch, barley bird and aberdevine. "
}, {
    "taxon_group": "Bird",
    ...
    "description": "The Eurasian blackcap (Sylvia atricapilla) usually known simply as the blackcap, is a common and widespread typical warbler. It has mainly olive-grey upperparts and pale grey underparts, and differences between the five subspecies are small. Both sexes have a neat coloured cap to the head, black in the male and reddish-brown in the female. The male's typical song is a rich musical warbling, often ending in a loud high-pitched crescendo, but a simpler song is given in some isolated areas, such as valleys in the Alps. The blackcap is a partial migrant; birds from the colder areas of its range winter in scrub or trees in northwestern Europe, around the Mediterranean and in tropical Africa. Some German birds have adapted to spending the winter in gardens in Great Britain and Ireland. Insects are the main food in the breeding season, but, for the rest of the year, blackcaps survive primarily on small fruit. Its rich and varied song has led to it being described as the \"mock nightingale\" and it has featured in literature, films and music. In Messiaen's opera Saint François d'Assise, the saint is represented by themes based on the blackcap's song.",
    "short_des": "The Eurasian blackcap (Sylvia atricapilla) usually known simply as the blackcap, is a common and widespread typical warbler. It has mainly olive-grey upperparts and pale grey underparts, and differences between the five subspecies are small."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Eurasian sparrowhawk (Accipiter nisus), also known as the northern sparrowhawk or simply the sparrowhawk, is a small bird of prey in the family Accipitridae. Adult male Eurasian sparrowhawks have bluish grey upperparts and orange-barred underparts."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common chaffinch (Fringilla coelebs), usually known simply as the chaffinch, is a common and widespread small passerine bird in the finch family. The male is brightly coloured with a blue-grey cap and rust-red underparts."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The European greenfinch, or just greenfinch (Chloris chloris) is a small passerine bird in the finch family Fringillidae.\nThis bird is widespread throughout Europe, north Africa and south west Asia."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The grey wagtail (Motacilla cinerea) is a member of the wagtail family, Motacillidae, measuring around 18–19 cm overall length. The species looks somewhat similar to the yellow wagtail but has the yellow on its underside restricted to the throat and vent."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The bullfinch, common bullfinch or Eurasian bullfinch (Pyrrhula pyrrhula) is a small passerine bird in the finch family Fringillidae. In Anglophone Europe it is known simply as bullfinch, as it is the original bird to bear the name bullfinch."
}, {
    "taxon_group": "Bird",
    ...
    "description": "The coal tit (Periparus ater) is a passerine bird in the tit family Paridae. It is a widespread and common resident breeder throughout temperate to subtropical Eurasia and northern Africa. The black-crested tit is now usually included in this species. The coal tit is 10–11.5 cm in length, and has a distinctive large white nape spot on its black head. The head, throat and neck of the adult are glossy blue-black, setting off the off-white sides of the face (tinged grey to yellow depending on subspecies) and the brilliant white nape; the white tips of the wing coverts appear as two wingbars. The underparts are whitish shading through buff to rufous on the flanks. The bill is black, the legs lead-coloured, and irides dark brown.",
    "short_des": "The coal tit (Periparus ater) is a passerine bird in the tit family Paridae. It is a widespread and common resident breeder throughout temperate to subtropical Eurasia and northern Africa. The black-crested tit is now usually included in this species."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The dunnock (Prunella modularis) is a small passerine, or perching bird, found throughout temperate Europe and into Asia. Dunnocks have also been successfully introduced into New Zealand. It is by far the most widespread member of the accentor family."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Phalacrocoracidae is a family of some 40 species of aquatic birds commonly known as cormorants and shags. Several different classifications of the family have been proposed recently, and the number of genera is disputed."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common chiffchaff, or simply the chiffchaff, (Phylloscopus collybita) is a common and widespread leaf warbler which breeds in open woodlands throughout northern and temperate Europe and Asia.\nIt is a migratory passerine which winters in southern and western Europe."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The little grebe (Tachybaptus ruficollis), also known as dabchick, is a member of the grebe family of water birds. The little grebe is a small water bird with a pointed bill. The adult is unmistakable in summer, predominantly dark above with its rich, rufous coloured neck."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The Eurasian collared dove (Streptopelia decaocto), most often simply called the collared dove, also sometimes hyphenated as Eurasian collared-dove, is a species of dove native to warm temperate and subtropical Asia, and introduced in North America in the 1980s."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "Starlings are small to medium-sized passerine birds in the family Sturnidae. The name \"Sturnidae\" comes from the Latin word for starling, sturnus. Many Asian species, particularly the larger ones, are called mynas, and many African species are known as glossy starlings."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The western jackdaw (Corvus monedula), also known as the Eurasian jackdaw, European jackdaw, or simply jackdaw, is a passerine bird in the crow family. Found across Europe, western Asia and North Africa, it is mostly resident."
}, {
    "taxon_group": "Bird",
    ...
    "description": "The house sparrow (Passer domesticus) is a bird of the sparrow family Passeridae, found in most parts of the world. A small bird, it has a typical length of 16 cm (6.3 in) and a mass of 24–39.5 g (0.85–1.39 oz). Females and young birds are coloured pale brown and grey, and males have brighter black, white, and brown markings.\nThe house sparrow is strongly associated with human habitations, and can live in urban or rural settings. Though found in widely varied habitats and climates, it typically avoids extensive woodlands, grasslands, and deserts away from human development. It feeds mostly on the seeds of grains and weeds, but it is an opportunistic eater and commonly eats insects and many other foods. Its predators include domestic cats, hawks, owls, and many other predatory birds and mammals.\nBecause of its numbers, ubiquity, and association with human settlements, the house sparrow is culturally prominent.Though it is widespread and abundant, its numbers have declined in some areas. The animal's conservation status is listed as least concern on the IUCN Red List.",
    "short_des": "The house sparrow (Passer domesticus) is a bird of the sparrow family Passeridae, found in most parts of the world. A small bird, it has a typical length of 16 cm (6.3 in) and a mass of 24–39.5 g (0.85–1.39 oz). Females and young birds are coloured pale brown and grey."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The spotted flycatcher (Muscicapa striata) is a small passerine bird in the Old World flycatcher family. It breeds in most of Europe and western Asia, and is migratory, wintering in Africa and south western Asia. It is declining in parts of its range."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The wagtails form the passerine bird genus Motacilla. The forest wagtail belongs to the monotypic genus Dendronanthus which is closely related to Motacilla and sometimes included herein. The common name and genus names are derived from their characteristic tail pumping behaviour."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The common pochard (/ˈpɒtʃə(r)d/) (Aythya ferina) is a medium-sized diving duck. The scientific name is derived from Greek aithuia an unidentified seabird mentioned by authors including Hesychius and Aristotle, and Latin ferina, \"wild game\", from ferus, ”wild\""
}, {
    "taxon_group": "Bird",
    ...
    "description": "The great crested grebe (Podiceps cristatus) is a member of the grebe family of water birds noted for its elaborate mating display. The scientific name comes from Latin. Podiceps is from podicis, \"vent\" and pes, \"foot\", and is a reference to the placement of a grebe's legs towards the rear of its body, and the species name, cristatus means ”crested\". The great crested grebe is the largest member of the grebe family found in the Old World, with some larger species residing in the Americas. They measure 46–51 cm (18–20 in) long with a 59–73 cm (23–29 in) wingspan and weigh 0.9 to 1.5 kg (2.0 to 3.3 lb).[3][4] It is an excellent swimmer and diver, and pursues its fish prey underwater. The adults are unmistakable in summer with head and neck decorations. In winter, this is whiter than most grebes, with white above the eye, and a pink bill.",
    "short_des": "The great crested grebe (Podiceps cristatus) is a member of the grebe family of water birds noted for its elaborate mating display. Podiceps is from podicis, \"vent\" and pes, \"foot\", and is a reference to the placement of a grebe's legs towards the rear of its body."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The tawny owl or brown owl (Strix aluco) is a stocky, medium-sized owl commonly found in woodlands across much of Eurasia. Its underparts are pale with dark streaks, and the upperparts are either brown or grey. Several of the eleven recognised subspecies have both variants"
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The willow warbler (Phylloscopus trochilus) is a very common and widespread leaf warbler which breeds throughout northern and temperate Europe and Asia, from Ireland east to the Anadyr River basin in eastern Siberia."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The European herring gull (Larus argentatus) is a large gull (up to 26 in (66 cm) long). One of the best known of all gulls along the shores of western Europe, it was once abundant."
}, {
    "taxon_group": "Bird",
    ...
    "short_des": "The swifts are a family, Apodidae, of highly aerial birds. They are superficially similar to swallows, but are not closely related to any of the passerine species. Swifts are placed in the order Apodiformes, which they share with hummingbirds."
}, {
    "taxon_group": "Mammal",
    ...
    "short_des": "Sciurus carolinensis, common name eastern gray squirrel or grey squirrel depending on region, is a tree squirrel in the genus Sciurus. It is native to eastern North America, but has since been introduced to European regions where it has become an invasive species."
}]
